...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="2500">
  ...
  <div class="carousel-inner" role="listbox" id="picture_list">
    <div class="item active">
      <a href="{{ route('picture','1') }}"><img class="lazy" src="http://ismta.oss-cn-shenzhen.aliyuncs.com/a1.jpg!.webp" alt="..."></a>
     ...
     <!-- picture 2----------------------------------->
    <div class="item">
      <a href="{{ route('picture', '2') }}"><img class="lazy" src="http://ismta.oss-cn-shenzhen.aliyuncs.com/a2.jpg!.webp" alt="..."></a>
      <div class="carousel-caption">
        酷炫DIY配置研究深度学习
      </div>
    </div>
