(function($) {
	$.fn.touchrotate = function(params) {
		...
		boxNode.style.transform = "rotateX(" + params.rotateX + "deg) rotateY(" + params.rotateY + "deg) rotateZ(0deg)";
		var isMove = true;
		var dowm_point = {};
		var isMove = false;
		...
		boxNode.addEventListener(mousedown, function(e) {
			...
			if(transitionLock) {
				...
				boxNode.style.transform = "rotateX(" + rotateX + "deg) rotateY(" + rotateY + "deg) rotateZ(0deg)";
		...
		boxNode.addEventListener(mousemove, function(e) {
            ...
            boxNode.style.transform = "rotateX(" + rotateX % 360 + "deg) rotateY(" + rotateY % 360 + "deg) rotateZ(0deg)";
		});
